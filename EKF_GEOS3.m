...
global Cnm Snm AuxParam eopdata n_eqn
...
% Model parameters
AuxParam = struct ('Mjd_TT',0,'n',0,'m',0);
...
[UT1_UTC, TAI_UTC, x_pole, y_pole] = IERS (eopdata, obs(18,1));
[UT1_TAI, UTC_GPS, UT1_GPS, TT_UTC, GPS_UTC] = timediff(UT1_UTC, TAI_UTC);
Mjd_TT = Mjd_UTC + TT_UTC/86400;
AuxParam.Mjd_UTC = Mjd_UTC;
AuxParam.Mjd_TT = Mjd_TT;

Y0 = DEInteg (@Accel,0,-(obs(18,1)-obs(1,1))*86400.0,1e-13,1e-6,6,Y);
